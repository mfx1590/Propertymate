...
| 4 | Verification engine: queue, admin dashboard, signed-URL doc viewer, decisions, freshness job | 🔜 **Next** | — | Minimal approve endpoint already exists; step 4 adds the queue UI, per-document decisions, rejection reason codes, freshness job |
