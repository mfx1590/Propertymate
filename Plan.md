...
**Phase 2 (§10.2) is complete** as of 2026-08-21 — the Expo app was the last item. **§6.1 is still only partly built** beyond the alerts added in step 14: mortgage/installment calculators with developer payment-plan schedules, region landing pages, polygon-draw filter and POI layers are all specified and unbuilt (compare view and multi-currency landed in step 15). Sorting by price/m² is already wired into Meilisearch. **Still open,
