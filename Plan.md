...
listings, lead inbox) and the listing wizard remain web-only by choice; non-English contract PDFs (needs an embedded
Unicode font — the PDF service transliterates today, so a Russian or Farsi contract still renders in Latin)
and purchase/off-plan sale-agreement templates. (§6.2 agent-mandate e-sign landed in step 18.) §13.2 **review moderation** was built in step 13; the one piece of it still
