...
pin view — tracing a polygon with a thumb is a different interaction, not a port of the web one; **Farsi contract rendering**, which needs an Arabic shaping pass rather than a font
