...
export class AuthController {
  ...
  verifyOtp(@Body() dto: VerifyOtpDto, @Ip() ip: string) {
    return this.authService.verifyOtp(dto.phone, dto.code, ip, dto.accountType, dto.referralCode);
  }
  ...
  register(@Body() dto: RegisterDto, @Ip() ip: string) {
    return this.authService.register(dto.email, dto.password, dto.locale, ip, dto.accountType, dto.referralCode);
  }
